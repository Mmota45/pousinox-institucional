-- Fix: scoring on-the-fly instead of pre-computing 3.4M rows
-- fn_top_prospects: returns top N scored prospects instantly via CTE

CREATE OR REPLACE FUNCTION fn_top_prospects(n int DEFAULT 20, filtro_uf text DEFAULT NULL)
RETURNS TABLE(
