      ...
      <div className={styles.pageHeader}>
        <div className="container">
          ...
          <p className={styles.pageSubtitle}>
            Fabricamos equipamentos e mobiliário em aço inox sob medida para oito segmentos.
            Selecione uma categoria para conhecer os itens disponíveis.
          </p>
        </div>
      </div>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.catCta}>
            <p className={styles.ctaNote}>
              Todos os itens podem ser fabricados sob medida. Não encontrou o que precisa?
              Entre em contato — desenvolvemos projetos personalizados.
            </p>
