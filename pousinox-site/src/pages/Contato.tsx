...
export default function Contato() {
  ...
  const waLink = cfg.whatsapp_numero ? `https://wa.me/${cfg.whatsapp_numero}?text=${encodeURIComponent(cfg.whatsapp_mensagem || 'Olá, gostaria de solicitar um orçamento.')}` : WA_LINK
  const webhookUrl = cfg.n8n_webhook_contato || N8N_WEBHOOK_URL
    ...
    <div className={styles.page}>
      ...
      <div className={styles.pageHeader}>
        <div className="container">
          <h1 className={styles.pageTitle}>{cfg.contato_titulo || 'Orçamento e Contato'}</h1>
          <p className={styles.pageSubtitle}>{cfg.contato_subtitulo || 'Fale com a POUSINOX® pelo canal de sua preferência. Respondemos rapidamente.'}</p>
        </div>
      </div>
      ...
      <div className={`container ${styles.layout}`}>
        ...
        <div className={styles.formSection}>
          <h2 className={styles.formTitle}>{cfg.contato_form_titulo || 'Solicitar orçamento'}</h2>
          <p className={styles.formDesc}>{cfg.contato_form_desc || 'Preencha o formulário abaixo com os detalhes do seu projeto. Nossa equipe entrará em contato em breve.'}</p>
            ...
            <ul className={styles.contactList}>
              <li>
                ...
                <div>
                  ...
                  <span>{cfg.contato_telefone || '(35) 3423-8994'}</span>
                </div>
              </li>
              <li>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <li>
                ...
                <div>
                  ...
                  <span>{cfg.contato_horario_1 || 'Seg–Qui: 7h30–11h30 / 13h15–18h'}</span>
                  <span>{cfg.contato_horario_2 || 'Sex: 7h30–11h30 / 13h15–17h'}</span>
                  <span>{cfg.contato_horario_3 || 'Sáb, Dom e Feriados: fechado'}</span>
                </div>
              </li>
            </ul>
          </div>
