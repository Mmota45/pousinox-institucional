      ...
      <section className={styles.hero}>
        ...
        <div className={`container ${styles.heroInner}`}>
          <div className={styles.heroContent}>
            <span className={styles.heroEyebrow}>Fabricamos em</span>
            <h1 className={styles.heroTitle}>Inox sob medida</h1>
            <p className={styles.heroTagline}>para cada necessidade</p>
            <p className={styles.heroSubtitle}>
              Soluções sob medida para quem exige higiene, precisão e durabilidade. Fabricado em Pouso Alegre, MG, para todo o Brasil.
            </p>
