-- ═══════════════════════════════════════════════════════════════
-- Fix: dropa tabelas/sequences parcialmente criadas e recria tudo
-- Execute no SQL Editor do Supabase
-- ═══════════════════════════════════════════════════════════════

-- Dropar na ordem correta (FK-safe)
DROP TABLE IF EXISTS itens_recebimento      CASCADE;
DROP TABLE IF EXISTS recebimentos_compra    CASCADE;
DROP TABLE IF EXISTS itens_pedido           CASCADE;
DROP TABLE IF EXISTS pedidos_compra         CASCADE;
DROP TABLE IF EXISTS itens_cotacao          CASCADE;
DROP TABLE IF EXISTS cotacoes_compra        CASCADE;
DROP TABLE IF EXISTS itens_solicitacao      CASCADE;
DROP TABLE IF EXISTS solicitacoes_compra    CASCADE;

DROP SEQUENCE IF EXISTS solicitacoes_compra_numero_seq;
DROP SEQUENCE IF EXISTS cotacoes_compra_numero_seq;
DROP SEQUENCE IF EXISTS pedidos_compra_numero_seq;
DROP SEQUENCE IF EXISTS recebimentos_compra_numero_seq;

-- ─── Solicitações de Compra ──────────────────────────────────────
CREATE SEQUENCE solicitacoes_compra_numero_seq START 1;
...
CREATE INDEX idx_itens_solicitacao_sol ON itens_solicitacao(solicitacao_id);

-- ─── Cotações de Compra ───────────────────────────────────────────
CREATE SEQUENCE cotacoes_compra_numero_seq START 1;

CREATE TABLE cotacoes_compra (
  id                  BIGSERIAL PRIMARY KEY,
  numero              TEXT UNIQUE NOT NULL
...
CREATE INDEX idx_cotacoes_solicitacao ON cotacoes_compra(solicitacao_id);
CREATE INDEX idx_cotacoes_fornecedor  ON cotacoes_compra(fornecedor_id);
CREATE INDEX idx_itens_cotacao_cot    ON itens_cotacao(cotacao_id);

-- ─── Pedidos de Compra ────────────────────────────────────────────
CREATE SEQUENCE pedidos_compra_numero_seq START 1;
...
CREATE INDEX idx_pedidos_cotacao   ON pedidos_compra(cotacao_id);
CREATE INDEX idx_pedidos_fornecedor ON pedidos_compra(fornecedor_id);
CREATE INDEX idx_itens_pedido_ped  ON itens_pedido(pedido_id);

-- ─── Recebimentos de Compra ───────────────────────────────────────
CREATE SEQUENCE recebimentos_compra_numero_seq START 1;
...
CREATE INDEX idx_itens_recebimento_rec ON itens_recebimento(recebimento_id);
